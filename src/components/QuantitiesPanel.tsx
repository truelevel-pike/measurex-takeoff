...
export default function QuantitiesPanel() {
  ...
  const toggleClassificationVisibility = useStore((s) => s.toggleClassificationVisibility);
    ...
    <>
      ...
      <div className="flex-1 overflow-y-auto px-1">
        {filtered.map((classification) => {
          ...
          const isHidden = hiddenClassificationIds.includes(classification.id);
              ...
              >
                ...
                <button
                  ...
                  onClick={(event) => {
                    ...
                    toggleClassificationVisibility(classification.id);
                  }}
