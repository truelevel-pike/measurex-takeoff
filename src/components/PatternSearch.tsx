...
export default function PatternSearch({ onClose, onAddToTakeoff, pdfPageImageData, currentPage = 1 }: PatternSearchProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
      <div data-testid="pattern-search-container" role="dialog" aria-modal="true" aria-label="Pattern Search" className="relative flex flex-col w-[680px] max-h-[80vh] rounded-xl shadow-2xl overflow-hidden"
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-[#2d2d4e]">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] text-gray-500 hidden sm:inline">— uses AI to find repeated elements</span>
          </div>
        ...
        {phase === 'draw' ? (
          <>
            ...
            <div className="flex justify-end px-5 pb-5 gap-3">
              ...
              <button
                data-testid="pattern-search-btn"
          ...
          <>
            ...
            {/* Results grid */}
            <div data-testid="pattern-search-results" className="flex-1 overflow-y-auto px-5 pb-3 space-y-2">
              {results.length === 0 && (
              ...
              {results.map((match) => (
                <div
                  key={match.id}
                  data-testid="pattern-search-result"
                  role="button"
                  tabIndex={0}
